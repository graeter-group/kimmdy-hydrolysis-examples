...
# source vps.tcl
#
# move_vp_render 1 3 0 frames frame 200 smooth
#
...
proc move_vp {start end {morph_frames 50} args} {
  ...
  for {set j $firstj} {$j<= ($morph_frames - 1)} {incr j} {
    ...
    if {$render} {
      ...
      render TachyonLOptiXInternal [file join $::VCR::dirName $::VCR::filePrefixName.$frametext.ppm]
      puts "Rendering frame [file join $::VCR::dirName $::VCR::filePrefixName.$frametext.ppm]"
      incr framenum
    }
