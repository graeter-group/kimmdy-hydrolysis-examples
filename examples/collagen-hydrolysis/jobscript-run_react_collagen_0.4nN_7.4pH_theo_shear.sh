#!/bin/env bash
#SBATCH --job-name=run_react_collagen_0.4nN_7.4pH_theo_shear
#SBATCH --output=run_react_collagen_0.4nN_7.4pH_theo_shear.slurm.out
#SBATCH --error=run_react_collagen_0.4nN_7.4pH_theo_shear.slurm.err
...
timeout ${CYCLE_buffered}h kimmdy -i kimmdy_just_reactions_collagen_0.4nN_7.4pH_theo_shear.yml --restart
...
if [ $HOURS -lt $CYCLE ]; then
  ...
  sbatch ./jobscript-run_react_collagen_0.4nN_7.4pH_theo_shear.sh
  exit 2
fi