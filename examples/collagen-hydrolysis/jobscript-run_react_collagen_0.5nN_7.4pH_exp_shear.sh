#!/bin/env bash
#SBATCH --job-name=run_react_collagen_0.5nN_7.4pH_exp_shear
#SBATCH --output=run_react_collagen_0.5nN_7.4pH_exp_shear.slurm.out
#SBATCH --error=run_react_collagen_0.5nN_7.4pH_exp_shear.slurm.err
...
timeout ${CYCLE_buffered}h kimmdy -i kimmdy_just_reactions_collagen_0.5nN_7.4pH_exp_shear.yml --restart
...
if [ $HOURS -lt $CYCLE ]; then
  ...
  sbatch ./jobscript-run_react_collagen_0.5nN_7.4pH_exp_shear.sh
  exit 2
fi